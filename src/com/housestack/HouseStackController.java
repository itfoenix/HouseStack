...
//        op15.setDate(LocalDate.now());
        Option op22 = new Option();
        op22.setName("Father / Mother");
        op22.setType(10);
        op22.setDate(LocalDate.now());

        Option op18 = new Option();
        op18.setName("Son / Daughter");
        op18.setType(10);
        op18.setDate(LocalDate.now());
        Option op19 = new Option();
        op19.setName("Husband / Wife");
        op19.setType(10);
        op19.setDate(LocalDate.now());
        Option op20 = new Option();
        op20.setName("Brother / Sister");
        op20.setType(10);
        op20.setDate(LocalDate.now());
        Option op21 = new Option();
        op21.setName("Other");
        op21.setType(10);
        op21.setDate(LocalDate.now());
////
...
//        oh.insertOption(op17);
        oh.insertOption(op22);
        oh.insertOption(op18);
        oh.insertOption(op19);
        oh.insertOption(op20);
        oh.insertOption(op21);
